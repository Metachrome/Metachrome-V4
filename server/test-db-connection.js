    ...
    app.get('/api/test-db', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    db = (_b.sent()).db;
                    return [4 /*yield*/, db.select().from(((_a = db.schema) === null || _a === void 0 ? void 0 : _a.users) || db.users).limit(5)];
                case 2:
                    users = _b.sent();
                    res.json({
                        success: true,
                        ...
                        users: users.map(function (u) { return ({ id: u.id, username: u.username, role: u.role }); }),
