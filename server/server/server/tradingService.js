...
var TradingService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, storage_1.storage.getBalance(finalUserId, 'USDT')];
                    case 2:
                        userBalance = _a.sent();
                        if (!(!userBalance && finalUserId.includes('-trading'))) return [3 /*break*/, 5];
                        // Create default balance for admin trading profiles
                        return [4 /*yield*/, storage_1.storage.updateBalance(finalUserId, 'USDT', '50000.00', '0.00')];
                    case 3:
                        // Create default balance for admin trading profiles
                        _a.sent();
                        return [4 /*yield*/, storage_1.storage.getBalance(finalUserId, 'USDT')];
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, priceService_1.priceService.getCurrentPrice(request.symbol)];
                    case 6:
                        ...
                        return [4 /*yield*/, storage_1.storage.updateBalance(finalUserId, 'USDT', newAvailable, newLocked)];
                    case 7:
                        _a.sent();
                        ...
                        return [4 /*yield*/, storage_1.storage.createTrade({
                                userId: finalUserId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, storage_1.storage.getUser(originalUserId)];
                    case 2:
                        user = _a.sent();
                        ...
                        return [4 /*yield*/, priceService_1.priceService.getCurrentPrice(trade_1.symbol)];
                    case 3:
                        currentPrice = _a.sent();
                        if (!currentPrice) {
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, storage_1.storage.updateBalance(trade_1.userId, 'USDT', Math.max(0, newAvailable).toString(), Math.max(0, newLocked).toString())];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    case 8:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, storage_1.storage.updateBalance(userId, 'USDT', newAvailable.toString(), Math.max(0, newLocked).toString())];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    TradingService.prototype.getActiveTrades = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, storage_1.storage.getActiveTrades(userId)];
            });
        });
    };
