...
if (multer) {
    var uploadStorage = multer.diskStorage({
        destination: function (req, file, cb) {
            var uploadDir = path_1.default.join(process.cwd(), 'uploads', 'contact');
...
function registerChatRoutes(app) {
    ...
    app.get("/api/admin/chat/conversations", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.get("/api/admin/chat/messages/:conversationId", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    // Admin: Send message
    app.post("/api/admin/chat/send", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/api/admin/chat/mark-read/:conversationId", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.patch("/api/admin/chat/conversation/:conversationId/status", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.patch("/api/admin/chat/conversation/:conversationId/priority", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.patch("/api/admin/chat/conversation/:conversationId/assign", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.delete("/api/admin/chat/message/:messageId", auth_1.requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
