        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, storage_1.storage.getUserByEmail(((_b = (_a = profile.emails) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.value) || '')];
                case 1:
                    user = _e.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, storage_1.storage.getUserByEmail(linkedinProfile.email || '')];
                case 3:
                    user = _a.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, storage_1.storage.getUserByEmail("".concat(twitterProfile.username, "@twitter.local"))];
                case 3:
                    user = _c.sent();
                    if (!!user) return [3 /*break*/, 5];
                    return [4 /*yield*/, storage_1.storage.createUser({
