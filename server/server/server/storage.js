...
var schema_sqlite_1 = require("@shared/schema-sqlite");
var db_1 = require("./db");
...
var DatabaseStorage = /** @class */ (function () {
    ...
    DatabaseStorage.prototype.getUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.users).where((0, drizzle_orm_1.eq)(schema_sqlite_1.users.id, id))];
                    case 1:
                        user = (_a.sent())[0];
    ...
    DatabaseStorage.prototype.getUserByWallet = function (walletAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.users).where((0, drizzle_orm_1.eq)(schema_sqlite_1.users.walletAddress, walletAddress))];
                    case 1:
                        user = (_a.sent())[0];
                        return [2 /*return*/, user];
                }
    ...
    DatabaseStorage.prototype.getUserByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.users).where((0, drizzle_orm_1.eq)(schema_sqlite_1.users.email, email))];
                    case 1:
                        user = (_a.sent())[0];
                        return [2 /*return*/, user];
                }
    ...
    DatabaseStorage.prototype.getUserByUsername = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.users).where((0, drizzle_orm_1.eq)(schema_sqlite_1.users.username, username))];
                    case 1:
                        user = (_a.sent())[0];
                        return [2 /*return*/, user];
                }
    ...
    DatabaseStorage.prototype.createUser = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.users).values(userData).returning()];
                    case 1:
                        user = (_a.sent())[0];
                        return [2 /*return*/, user];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, safeDelete('Step 1: Deleting chat messages', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["DELETE FROM chat_messages WHERE sender_id = ", ""], ["DELETE FROM chat_messages WHERE sender_id = ", ""])), id)))];
                    case 1:
                        // Delete all related records in the correct order
                        // Using safeDelete to handle tables that might not exist
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 2: Deleting chat conversations', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["DELETE FROM chat_conversations WHERE user_id = ", " OR assigned_admin_id = ", ""], ["DELETE FROM chat_conversations WHERE user_id = ", " OR assigned_admin_id = ", ""])), id, id)))];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 3: Nullifying contact request references', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["UPDATE contact_requests SET conversation_id = NULL WHERE conversation_id IN (SELECT id FROM chat_conversations WHERE user_id = ", ")"], ["UPDATE contact_requests SET conversation_id = NULL WHERE conversation_id IN (SELECT id FROM chat_conversations WHERE user_id = ", ")"])), id)))];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 4: Deleting verification documents', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["DELETE FROM user_verification_documents WHERE user_id = ", ""], ["DELETE FROM user_verification_documents WHERE user_id = ", ""])), id)))];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 5: Nullifying redeem history references', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["UPDATE user_redeem_history SET user_id = NULL WHERE user_id = ", ""], ["UPDATE user_redeem_history SET user_id = NULL WHERE user_id = ", ""])), id)))];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 6: Deleting deposit requests', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["DELETE FROM deposit_requests WHERE user_id = ", ""], ["DELETE FROM deposit_requests WHERE user_id = ", ""])), id)))];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 7: Deleting withdrawal requests', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["DELETE FROM withdrawal_requests WHERE user_id = ", ""], ["DELETE FROM withdrawal_requests WHERE user_id = ", ""])), id)))];
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 8: Deleting trading controls', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["DELETE FROM trading_controls WHERE user_id = ", ""], ["DELETE FROM trading_controls WHERE user_id = ", ""])), id)))];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 9: Deleting transactions', db_1.db.delete(schema_sqlite_1.transactions).where((0, drizzle_orm_1.eq)(schema_sqlite_1.transactions.userId, id)))];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 10: Deleting trades', db_1.db.delete(schema_sqlite_1.trades).where((0, drizzle_orm_1.eq)(schema_sqlite_1.trades.userId, id)))];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 11: Deleting balances', db_1.db.delete(schema_sqlite_1.balances).where((0, drizzle_orm_1.eq)(schema_sqlite_1.balances.userId, id)))];
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 12: Deleting admin controls', db_1.db.delete(schema_sqlite_1.adminControls).where((0, drizzle_orm_1.eq)(schema_sqlite_1.adminControls.userId, id)))];
                    case 12:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 13: Nullifying admin control creator references', db_1.db.update(schema_sqlite_1.adminControls).set({ createdBy: null }).where((0, drizzle_orm_1.eq)(schema_sqlite_1.adminControls.createdBy, id)))];
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, safeDelete('Step 14: Deleting messages', db_1.db.execute((0, drizzle_orm_1.sql)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["DELETE FROM messages WHERE from_user_id = ", " OR to_user_id = ", ""], ["DELETE FROM messages WHERE from_user_id = ", " OR to_user_id = ", ""])), id, id)))];
                    case 14:
                        _a.sent();
                        // Finally delete the user - this must succeed
                        console.log('Step 15: Deleting user record...');
                        return [4 /*yield*/, db_1.db.delete(schema_sqlite_1.users).where((0, drizzle_orm_1.eq)(schema_sqlite_1.users.id, id))];
                    case 15:
                        _a.sent();
    ...
    DatabaseStorage.prototype.getUserBalances = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.balances).where((0, drizzle_orm_1.eq)(schema_sqlite_1.balances.userId, userId))];
    ...
    DatabaseStorage.prototype.getBalance = function (userId, currency) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.CacheManager.getUserBalance(userId, currency, function () { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
                                            var balance;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, db_1.db
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        cache_1.CacheManager.invalidateUserBalances(userId, currency);
                                        return [2 /*return*/, balance];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.balances).values(balanceData).returning()];
                                    case 1:
                                        balance = (_a.sent())[0];
                                        cache_1.CacheManager.invalidateUserBalances(balanceData.userId, balanceData.currency);
                                        return [2 /*return*/, balance];
                                }
                            });
                        }); })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.trades).values(tradeData).returning()];
                    case 1:
                        trade = (_a.sent())[0];
    ...
    DatabaseStorage.prototype.getTrade = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_sqlite_1.trades).where((0, drizzle_orm_1.eq)(schema_sqlite_1.trades.id, id))];
                    case 1:
                        trade = (_a.sent())[0];
                        if (trade) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.trades).values({
                                id: spotOrder.id,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.balances).values({
                            id: crypto.randomUUID(),
                            userId: userId,
                            currency: currency,
    ...
    DatabaseStorage.prototype.getMarketData = function (symbol) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.CacheManager.getMarketData(symbol, function () { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.marketData).values(data).returning()];
                                    case 1:
    ...
    DatabaseStorage.prototype.getAllMarketData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.CacheManager.getAllMarketData(function () { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    DatabaseStorage.prototype.getTradingPairs = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.CacheManager.getTradingPairs(function () { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cache_1.PerformanceMonitor.measureQuery(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.transactions).values(normalizedData).returning()];
                    case 1:
    ...
    DatabaseStorage.prototype.createAdminControl = function (controlData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.adminControls).values(controlData).returning()];
                    case 1:
                        control = (_a.sent())[0];
    ...
    DatabaseStorage.prototype.createOptionsSettings = function (settingsData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.insert(schema_sqlite_1.optionsSettings).values(settingsData).returning()];
                    case 1:
                        settings = (_a.sent())[0];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, db_1.db.select({
                            id: schema_sqlite_1.users.id,
                            email: schema_sqlite_1.users.email,
                            username: schema_sqlite_1.users.username,
                            password: schema_sqlite_1.users.password, // Explicitly include password for superadmin access
                            firstName: schema_sqlite_1.users.firstName,
                            lastName: schema_sqlite_1.users.lastName,
                            profileImageUrl: schema_sqlite_1.users.profileImageUrl,
                            walletAddress: schema_sqlite_1.users.walletAddress,
                            role: schema_sqlite_1.users.role,
                            isActive: schema_sqlite_1.users.isActive,
                            status: schema_sqlite_1.users.status,
                            adminNotes: schema_sqlite_1.users.adminNotes,
                            verificationStatus: schema_sqlite_1.users.verificationStatus,
                            hasUploadedDocuments: schema_sqlite_1.users.hasUploadedDocuments,
                            tradingMode: schema_sqlite_1.users.tradingMode,
                            balance: schema_sqlite_1.users.balance,
                            lastLogin: schema_sqlite_1.users.lastLogin,
                            createdAt: schema_sqlite_1.users.createdAt,
                            updatedAt: schema_sqlite_1.users.updatedAt,
                        }).from(schema_sqlite_1.users).orderBy((0, drizzle_orm_1.desc)(schema_sqlite_1.users.createdAt))];
                    case 1:
                        result = _b.sent();
...
var DemoStorage = /** @class */ (function () {
    ...
    DemoStorage.prototype.updateUserPassword = function (userId, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
var SafeStorage = /** @class */ (function () {
    ...
    SafeStorage.prototype.updateUserPassword = function (userId, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.tryDatabase(function () { return _this.dbStorage.updateUserPassword(userId, hashedPassword); })];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
