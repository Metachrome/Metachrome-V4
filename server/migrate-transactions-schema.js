...
function migrateTransactionsSchema() {
    return __awaiter(this, void 0, void 0, function () {
        var currentSchema, amountColumn, alterError_1, updatedSchema, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    amountColumn = (_a = currentSchema.rows) === null || _a === void 0 ? void 0 : _a.find(function (col) { return col.column_name === 'amount'; });
                    if (!amountColumn) return [3 /*break*/, 6];
                    console.log("Current amount column type: ".concat(amountColumn.data_type));
                    if (!(amountColumn.data_type.includes('numeric') || amountColumn.data_type.includes('decimal'))) return [3 /*break*/, 5];
                    console.log('✅ Amount column exists and is decimal type');
                    if (!!amountColumn.data_type.includes('18,8')) return [3 /*break*/, 5];
