...
import { hashPassword, verifyPassword, generateToken, verifyToken, requireAdmin, requireAuth, requireSessionAdmin, requireSessionSuperAdmin } from "./auth";
...
export function registerRoutes(app) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            app.get("/api/admin/notifications", requireSessionSuperAdmin, function (req, res) {
                try {
            ...
            app.post("/api/admin/notifications/:id/read", requireSessionSuperAdmin, function (req, res) {
                try {
            ...
            app.post("/api/admin/notifications/read-all", requireSessionSuperAdmin, function (req, res) {
                try {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, ((_b = storage.getUserByWallet) === null || _b === void 0 ? void 0 : _b.call(storage, walletAddress))];
                        case 1:
                            user_2 = _c.sent();
                            isNewUser = false;
                        ...
                        case 3: 
                        // Update last login
                        return [4 /*yield*/, storage.updateUser(user_2.id, { lastLogin: new Date() })];
                        case 4:
                            // Update last login
                            _c.sent();
                        ...
                        case 12:
                            ...
                            // Update last login
                            return [4 /*yield*/, storage.updateUser(user.id, { lastLogin: new Date() })];
                        case 13:
                            // Update last login
                            _c.sent();
                            // Store user in session
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            isValidPassword = true;
                            return [3 /*break*/, 5];
                        case 3: return [4 /*yield*/, verifyPassword(password, user.password || '')];
                        case 4:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.getUserByEmail(username)];
                        case 2:
                            user = _b.sent();
                            _b.label = 3;
                        case 3:
                            if (!(!user && username.startsWith('0x'))) return [3 /*break*/, 5];
                            return [4 /*yield*/, storage.getUserByWallet(username)];
                        case 4:
                            user = _b.sent();
                            _b.label = 5;
                        case 5:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, ((_b = storage.getUserByWalletAddress) === null || _b === void 0 ? void 0 : _b.call(storage, walletAddress))];
                        case 1:
                            user = _c.sent();
            ...
            app.get("/api/market-data", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getAllMarketData()];
                        case 1:
                            marketData = _a.sent();
                            res.json(marketData);
                            return [3 /*break*/, 3];
            ...
            app.get("/api/trading-pairs", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getTradingPairs()];
                        case 1:
                            pairs = _a.sent();
                            res.json(pairs);
                            return [3 /*break*/, 3];
            ...
            app.get("/api/user/profile", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.put("/api/user/profile", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateUser(userId, updateData)];
                        case 1:
                            updatedUser = _d.sent();
                            if (!updatedUser) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserByWallet(walletAddress)];
                        case 1:
                            user = _b.sent();
                            if (!!user) return [3 /*break*/, 3];
                            return [4 /*yield*/, storage.createUser({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserBalances(userId)];
                        case 1:
                            balances = _a.sent();
                            res.json(balances);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateBalance(userId, symbol, available, locked)];
                        case 1:
                            balance = _b.sent();
                            res.json(balance);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.createTrade(tradeData)];
                        case 1:
                            trade = _a.sent();
                            res.json(trade);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, tradingService.createOptionsTrade({
                                    userId: finalUserId,
                                    symbol: symbol,
                                    direction: direction,
                                    amount: amount,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, tradingService.cancelTrade(id, userId)];
                        case 1:
                            success = _a.sent();
                            if (success) {
            ...
            app.get("/api/users/:userId/trades", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var userId, limit, trades, completedTrades, error_21;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            ...
                            return [4 /*yield*/, storage.getUserTrades(userId, limit)];
                        case 1:
                            trades = _a.sent();
                            completedTrades = trades.filter(function (t) { return t.status === 'completed'; });
                            console.log("\uD83D\uDCCA GET /api/users/".concat(userId, "/trades:"), {
                                totalTrades: trades.length,
                                completedTrades: completedTrades.length,
                                tradeStatuses: trades.map(function (t) { return ({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            id = req.params.id;
                            updates = req.body;
                            return [4 /*yield*/, storage.updateTrade(id, updates)];
                        case 1:
                            trade = _a.sent();
                            res.json(trade);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            id = req.params.id;
                            return [4 /*yield*/, storage.getTrade(id)];
                        case 1:
                            trade = _a.sent();
                            if (!trade) {
            ...
            app.post("/api/spot/orders", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.createSpotOrder({
                                    userId: userId,
                                    symbol: symbol,
                                    side: side,
                                    type: type,
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, storage.updateUserBalance(userId, 'USDT', -totalNum)];
                        case 3:
                            // BUY: Deduct USDT, Add Cryptocurrency
                            _e.sent();
                            return [4 /*yield*/, storage.updateUserBalance(userId, cryptoSymbol_1, amountNum)];
                        case 4:
                            _e.sent();
            ...
            app.get("/api/spot/orders", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserSpotOrders(userId)];
                        case 1:
                            orders = _b.sent();
                            res.json(orders);
                            return [3 /*break*/, 3];
            ...
            app.delete("/api/spot/orders/:id", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getSpotOrder(id)];
                        case 1:
                            order = _b.sent();
                            if (!order) {
                            ...
                            return [4 /*yield*/, storage.updateSpotOrder(id, { status: 'cancelled' })];
                        case 2:
                            // Cancel order and refund locked funds
                            _b.sent();
                            if (!(order.side === 'buy')) return [3 /*break*/, 4];
                            return [4 /*yield*/, storage.updateUserBalance(userId, 'USDT', order.total)];
                        case 3:
                            _b.sent();
                            return [3 /*break*/, 6];
                        case 4: return [4 /*yield*/, storage.updateUserBalance(userId, 'BTC', order.amount)];
                        case 5:
                            _b.sent();
                            _b.label = 6;
                        case 6:
            ...
            app.post("/api/transactions", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            transactionData = insertTransactionSchema.parse(req.body);
                            return [4 /*yield*/, storage.createTransaction(transactionData)];
                        case 1:
                            transaction = _a.sent();
            ...
            app.post("/api/transactions/topup", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            transaction = _b.sent();
                            return [4 /*yield*/, storage.getBalance(userId, currency)];
                        case 2:
                            currentBalance = _b.sent();
                            newAvailable = currentBalance ?
                                (parseFloat(currentBalance.available || '0') + amountNum).toString() :
                                amount.toString();
                            return [4 /*yield*/, storage.updateBalance(userId, currency, newAvailable, (currentBalance === null || currentBalance === void 0 ? void 0 : currentBalance.locked) || '0')];
                        case 3:
                            _b.sent();
                            res.json({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            id = req.params.id;
                            return [4 /*yield*/, storage.getUserTransactions(id)];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(userId, limit)];
                        case 1:
            ...
            // Admin endpoints
            app.post("/api/admin/controls", requireAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var controlData, control, error_32;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            controlData = insertAdminControlSchema.parse(req.body);
                            return [4 /*yield*/, storage.createAdminControl(controlData)];
                        case 1:
                            control = _a.sent();
                            res.json(control);
                            return [3 /*break*/, 3];
            ...
            app.get("/api/admin/controls/:userId", requireAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            userId = req.params.userId;
                            return [4 /*yield*/, storage.getAdminControl(userId)];
                        case 1:
                            control = _a.sent();
                            res.json(control);
                            return [3 /*break*/, 3];
            ...
            app.patch("/api/admin/controls/:id", requireAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            id = req.params.id;
                            updates = req.body;
                            return [4 /*yield*/, storage.updateAdminControl(id, updates)];
                        case 1:
                            control = _a.sent();
                            res.json(control);
                            return [3 /*break*/, 3];
            ...
            app.put("/api/admin/controls/:id", requireAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.delete("/api/admin/controls/:id", requireAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var id, error_36;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            id = req.params.id;
                            return [4 /*yield*/, storage.deleteAdminControl(id)];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, db.select().from(transactions).limit(1)];
                        case 2:
                            sampleTx = _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.getAdminControl(trade_1.userId)];
                        case 2:
                            adminControl = _b.sent();
                            return [4 /*yield*/, storage.getMarketData(trade_1.symbol)];
                        case 3:
                        ...
                        case 6:
                            ...
                            return [4 /*yield*/, storage.updateBalance(trade_1.userId, 'USDT', newAvailable.toString(), Math.max(0, newLocked).toString())];
                        case 7:
                            _b.sent();
                            _b.label = 8;
                        case 8:
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, storage.getTransaction(transaction.id)];
                        case 10:
                            verifyTx = _b.sent();
            ...
            app.get("/api/admin/users", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.get("/api/admin/controls", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var controls, error_41;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getAllAdminControls()];
                        case 1:
                            controls = _a.sent();
                            res.json(controls);
                            return [3 /*break*/, 3];
            ...
            app.post("/api/admin/controls", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.createAdminControl({
                                    userId: userId,
            ...
            app.put("/api/admin/controls/:id", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.delete("/api/admin/controls/:id", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var id, error_44;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            app.get("/api/admin/trading-controls", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var controls, error_45;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getTradingControls()];
                        case 1:
                            controls = _a.sent();
                            res.json(controls);
                            return [3 /*break*/, 3];
            ...
            app.post("/api/admin/trading-controls", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserById(userId)];
                        case 1:
                            user = _d.sent();
                            if (!user) {
                            ...
                            return [4 /*yield*/, storage.createTradingControl(userId, controlType, notes, adminId)];
                        case 2:
                            control = _d.sent();
                            // Log activity
                            return [4 /*yield*/, logAdminActivityFromRequest(req, ActionTypes.TRADING_CONTROL_SET, ActionCategories.TRADING, "Set trading mode to ".concat(controlType.toUpperCase(), " for user ").concat(user.username || user.email), { id: userId, username: user.username, email: user.email }, { controlType: controlType, notes: notes, previousMode: user.tradingMode || 'normal' })];
                        case 3:
                            // Log activity
                            _d.sent();
                            res.json(control);
            ...
            app.put("/api/admin/trading-controls/:id", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateTradingControl(id, { controlType: controlType, notes: notes, isActive: isActive })];
                        case 1:
                            control = _b.sent();
                            res.json(control);
                            return [3 /*break*/, 3];
            ...
            app.get("/api/admin/user-wallets", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var wallets, error_48;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getUserWallets()];
                        case 1:
                            wallets = _a.sent();
                            res.json(wallets);
                            return [3 /*break*/, 3];
            ...
            app.post("/api/admin/redeem-codes/:id/action", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateRedeemCode(id, updates)];
                        case 1:
                            updated = _c.sent();
                            return [2 /*return*/, res.json({
                                    success: true,
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, storage.disableRedeemCode(id)];
                        case 3:
                            updated = _c.sent();
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, storage.deleteRedeemCode(id)];
                        case 5:
                            _c.sent();
            ...
            app.put("/api/admin/users/update-password", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            hashedPassword = _b.sent();
                            return [4 /*yield*/, storage.updateUserPassword(userId, hashedPassword, newPassword)];
                        case 2:
                            _b.sent();
            ...
            app.put("/api/admin/users/update-wallet", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateUserWallet(userId, walletAddress)];
                        case 1:
                            _b.sent();
            ...
            app.put("/api/admin/users/update-status", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.updateUser(userId, {
                                    status: status_1,
            ...
            app.post("/api/admin/deposit", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            // Update balance
                            return [4 /*yield*/, storage.updateBalance(userId, 'USDT', newAmount.toString(), (currentBalance === null || currentBalance === void 0 ? void 0 : currentBalance.locked) || '0')];
                        case 3:
                            // Update balance
                            _b.sent();
                            return [4 /*yield*/, storage.createTransaction({
            ...
            app.post("/api/admin/withdraw", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            newAmount = currentAmount - parseFloat(amount);
                            // Update balance
                            return [4 /*yield*/, storage.updateBalance(userId, 'USDT', newAmount.toString(), currentBalance.locked)];
                        case 3:
                            // Update balance
                            _b.sent();
                            return [4 /*yield*/, storage.createTransaction({
            ...
            app.get("/api/admin/balances", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var balances, error_55;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getAllBalances()];
                        case 1:
                            balances = _a.sent();
                            res.json(balances);
                            return [3 /*break*/, 3];
            ...
            app.put("/api/admin/balances/:userId/:symbol", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [4 /*yield*/, storage.getBalance(userId, symbol.toUpperCase())];
                        case 2:
                            currentBalance = _b.sent();
            ...
            app.put("/api/admin/balances/:userId", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.updateBalance(userId, 'USDT', newAmount.toString(), '0')];
                        case 2:
            ...
            app.put("/api/admin/users/:id/role", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserById(id)];
                        case 1:
                            userBefore = _a.sent();
                            previousRole = (userBefore === null || userBefore === void 0 ? void 0 : userBefore.role) || 'unknown';
                            return [4 /*yield*/, storage.updateUser(id, { role: role })];
                        case 2:
                            user = _a.sent();
                            if (!user) return [3 /*break*/, 4];
                            return [4 /*yield*/, logAdminActivityFromRequest(req, ActionTypes.USER_ROLE_CHANGED, ActionCategories.USER_MANAGEMENT, "Changed role for user ".concat(user.username || user.email, " from ").concat(previousRole, " to ").concat(role), { id: user.id, username: user.username, email: user.email }, { previousRole: previousRole, newRole: role })];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4:
            ...
            app.put("/api/admin/users/:id/status", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.updateUser(id, { isActive: isActive })];
                        case 1:
                            user = _a.sent();
                            res.json(user);
                            return [3 /*break*/, 3];
            ...
            app.put("/api/admin/users/:id", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2: return [4 /*yield*/, storage.updateUser(id, updates)];
                        case 3:
                            user = _b.sent();
                            res.json(user);
                            return [3 /*break*/, 5];
            ...
            app.delete("/api/admin/users/:id", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.deleteUser(id)];
                        case 2:
                            _a.sent();
                            // Log activity
                            return [4 /*yield*/, logAdminActivityFromRequest(req, ActionTypes.USER_DELETED, ActionCategories.USER_MANAGEMENT, "Deleted user ".concat(user.username || user.email, " (ID: ").concat(id, ")"), { id: user.id, username: user.username, email: user.email }, { role: user.role, walletAddress: user.walletAddress })];
                        case 3:
                            // Log activity
                            _a.sent();
            ...
            app.post("/api/admin/messages", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.get("/api/admin/messages/:userId", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(userId_1, 200)];
                        case 1:
            ...
            app.post("/api/messages", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.get("/api/messages/:userId", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(userId_2, 200)];
                        case 1:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, storage.updateBalance(user.id, balance.symbol, '0.00', '0.00')];
                        case 5:
                            // Update balance to zero
                            _b.sent();
                            resetCount++;
            ...
            app.get("/api/admin/trades", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getAllTrades()];
                        case 1:
                            trades = _a.sent();
                            res.json(trades);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            id = req.params.id;
                            updates = req.body;
                            return [4 /*yield*/, storage.updateOptionsSettings(id, updates)];
                        case 1:
                            settings = _a.sent();
                            res.json(settings);
                            return [3 /*break*/, 3];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, storage.updateBalance(user.id, 'USDT', userMainBalance.toString(), usdtBalance.locked || '0.00')];
                        case 4:
                            _b.sent();
                            _b.label = 5;
                        case 5: return [4 /*yield*/, storage.getUserBalances(user.id)];
                        case 6:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTrades(user.id, 50)];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(user.id, 50)];
                        case 1:
            ...
            app.post("/api/transactions/topup", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            transaction = _b.sent();
                            return [4 /*yield*/, storage.getBalance(user.id, currency)];
                        case 2:
                            currentBalance = _b.sent();
                            newAvailable = currentBalance
                                ? (parseFloat(currentBalance.available) + parseFloat(amount)).toString()
                                : amount;
                            return [4 /*yield*/, storage.updateBalance(user.id, currency, newAvailable, (currentBalance === null || currentBalance === void 0 ? void 0 : currentBalance.locked) || '0')];
                        case 3:
                            _b.sent();
                            res.json({
                                transaction: transaction,
            ...
            app.post("/api/transactions/deposit-request", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.post("/api/transactions/submit-proof", requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getTransactionsByUserId(user.id)];
                        case 1:
                            ...
                            return [4 /*yield*/, storage.updateTransaction(transaction.id, {
                                    status: 'verifying',
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.updateTransaction(transaction.id, { status: 'completed' })];
                        case 2:
                            // Update transaction status to completed for verified card payments
                            _b.sent();
                            return [4 /*yield*/, storage.getBalance(user.id, currency)];
            ...
            app.post("/api/admin/transactions/:id/approve", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getTransaction(id)];
                        case 1:
                            transaction = _d.sent();
                            if (!transaction) {
                            ...
                            return [4 /*yield*/, storage.updateTransaction(id, {
                                    status: 'completed',
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, storage.getBalance(transaction.userId, transaction.symbol)];
                        case 3:
                            currentBalance = _d.sent();
                            newAvailable = currentBalance
                                ? (parseFloat(currentBalance.available) + parseFloat(transaction.amount)).toString()
                                : transaction.amount;
                            return [4 /*yield*/, storage.updateBalance(transaction.userId, transaction.symbol, newAvailable, (currentBalance === null || currentBalance === void 0 ? void 0 : currentBalance.locked) || '0')];
                        case 4:
                            _d.sent();
                            _d.label = 5;
                        case 5:
            ...
            app.post("/api/admin/deposits/:id/action", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.getUserById(transaction.userId)];
                        case 2:
                            user = _d.sent();
                        ...
                        case 7:
                            ...
                            return [3 /*break*/, 12];
                        case 8: return [4 /*yield*/, storage.updateTransaction(id, {
                                status: 'failed',
                                metadata: JSON.stringify(__assign(__assign({}, JSON.parse(transaction.metadata || '{}')), { rejectedBy: (_c = req.session.user) === null || _c === void 0 ? void 0 : _c.id, rejectedAt: new Date().toISOString(), rejectionReason: reason || 'No reason provided' }))
                            })];
                        case 9:
            ...
            app.post("/api/admin/withdrawals/:id/action", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.get("/api/admin/transactions/pending", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var pendingTransactions, error_79;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storage.getPendingTransactions()];
                        case 1:
            ...
            app.post("/api/admin/verify-document/:id", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var id, _a, status_2, adminNotes, document_1, user, updatedDocument, error_80;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 5, , 6]);
                            ...
                            return [4 /*yield*/, storage.getVerificationDocumentById(id)];
                        case 1:
                            document_1 = _b.sent();
                            if (!document_1) {
                            ...
                            return [4 /*yield*/, storage.getUserById(document_1.userId)];
                        case 2:
                            user = _b.sent();
                            if (!user) {
                                return [2 /*return*/, res.status(404).json({ message: "User not found" })];
                            }
                            return [4 /*yield*/, storage.updateVerificationDocument(id, {
                        ...
                        case 3:
                            ...
                            // Log activity
                            return [4 /*yield*/, logAdminActivityFromRequest(req, status_2 === 'approved' ? ActionTypes.VERIFICATION_APPROVED : ActionTypes.VERIFICATION_REJECTED, ActionCategories.VERIFICATION, "".concat(status_2 === 'approved' ? 'Approved' : 'Rejected', " ").concat(document_1.documentType, " verification for user ").concat(user.username || user.email), { id: user.id, username: user.username, email: user.email }, {
                                    documentId: id,
                                    documentType: document_1.documentType,
                                    verificationStatus: status_2,
                                    adminNotes: adminNotes || "Document ".concat(status_2, " by admin")
                                })];
                        case 4:
                            // Log activity
                            _b.sent();
                            console.log("\u2705 Document ".concat(status_2, ": ").concat(document_1.documentType, " for user ").concat(user.username || user.email));
                            res.json({
                                message: "Document ".concat(status_2, " successfully"),
                                document: __assign(__assign({}, updatedDocument), { verification_status: status_2, admin_notes: adminNotes || "Document ".concat(status_2, " by admin"), verified_at: new Date().toISOString() })
                            });
                            return [3 /*break*/, 6];
                        case 5:
                            error_80 = _b.sent();
            ...
            app.get("/api/admin/schema-check", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(user.id, 1)];
                        case 1:
                            txs = _a.sent();
            ...
            app.get("/api/admin/test-db", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(user.id, 5)];
                        case 1:
                            userTransactions = _a.sent();
            ...
            app.get("/api/admin/check-schema", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 9]);
                            return [4 /*yield*/, storage.getAllTransactions()];
                        case 2:
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, storage.getUserTransactions(user.id, 10)];
                        case 5:
                            allTransactions = _a.sent();
            ...
            app.post("/api/admin/fix-pending-trade-transactions", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var allTransactions, pendingTradeTransactions, updated, errors, errorDetails, _i, pendingTradeTransactions_1, tx, error_84, errorMsg, summary, error_85;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                        ...
                        case 1:
                            allTransactions = _a.sent();
                            pendingTradeTransactions = allTransactions.filter(function (tx) {
                                return (tx.type === 'trade_win' || tx.type === 'trade_loss') &&
                                    tx.status === 'pending';
                            });
                            console.log("\uD83D\uDCCA Found ".concat(pendingTradeTransactions.length, " pending trade transactions"));
                            ...
                            errors = 0;
                            errorDetails = [];
                            _i = 0, pendingTradeTransactions_1 = pendingTradeTransactions;
                            _a.label = 2;
                        case 2:
                            if (!(_i < pendingTradeTransactions_1.length)) return [3 /*break*/, 7];
                            tx = pendingTradeTransactions_1[_i];
                            _a.label = 3;
                        case 3:
                            _a.trys.push([3, 5, , 6]);
                            return [4 /*yield*/, storage.updateTransaction(tx.id, {
                                    status: 'completed'
                                })];
                        case 4:
                            _a.sent();
                            updated++;
                            console.log("\u2705 Updated transaction ".concat(tx.id, " to completed"));
                            return [3 /*break*/, 6];
                        case 5:
                            error_84 = _a.sent();
                            errors++;
                            errorMsg = error_84.message || String(error_84);
                            console.error("\u274C Failed to update transaction ".concat(tx.id, ":"), errorMsg);
                            errorDetails.push({
                                transactionId: tx.id,
                                error: errorMsg
                            });
                        ...
                        case 8:
                            error_85 = _a.sent();
                            console.error("❌ Error fixing pending trade transactions:", error_85);
                            res.status(500).json({
                                message: "Failed to fix pending trade transactions",
                                error: error_85.message
                            });
                            return [3 /*break*/, 9];
                        case 9: return [2 /*return*/];
                    }
            ...
            app.post("/api/admin/backfill-transactions", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var allTrades, tradeError_1, completedTrades, created, skipped, errors, errorDetails, _loop_1, _i, completedTrades_1, trade, summary, error_86;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 9, , 10]);
                        ...
                        case 4:
                            ...
                            _loop_1 = function (trade) {
                                var existingTransactions, hasTransaction, isWin, profit, transactionType, transactionAmount, error_87, errorMsg;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _b.trys.push([0, 3, , 4]);
                                            return [4 /*yield*/, storage.getUserTransactions(trade.userId, 1000)];
                                        case 1:
                                        ...
                                        case 3:
                                            error_87 = _b.sent();
                                            errors++;
                                            errorMsg = error_87.message || String(error_87);
                        ...
                        case 9:
                            error_86 = _a.sent();
                            console.error("❌ Error during transaction backfill:", error_86);
                            console.error("❌ Error stack:", error_86.stack);
                            res.status(500).json({
                                message: "Failed to backfill transactions",
                                error: error_86.message || String(error_86),
                                stack: error_86.stack
                            });
                            return [3 /*break*/, 10];
                        case 10: return [2 /*return*/];
                    }
            ...
            app.get("/api/admin/transactions", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var allTransactions, error_88;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                        ...
                        case 2:
                            error_88 = _a.sent();
                            console.error("Error fetching all transactions:", error_88);
                            res.status(500).json({ message: "Failed to fetch transactions" });
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
            ...
            app.post("/api/withdrawals", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var user, _a, amount, currency, address, password, userTrades, completedTrades, completedTradesCount, MINIMUM_TRADES_REQUIRED, currentBalance, withdrawalId, _b, withdrawalData, withdrawalError, transaction, newAvailable, notification, error_89;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 6, , 7]);
                            ...
                            return [4 /*yield*/, storage.getUserTrades(user.id, 100)];
                        case 1:
                            userTrades = _c.sent();
                            console.log("\uD83D\uDD0D DEBUG - Raw trades for ".concat(user.username || user.email, ":"), JSON.stringify(userTrades, null, 2));
                            completedTrades = userTrades.filter(function (trade) {
                                var isCompleted = trade.status === 'completed';
                                var hasResult = !!trade.result;
                                var isValidResult = trade.result && ['win', 'lose', 'normal'].includes(trade.result.toLowerCase());
                                console.log("  Trade ".concat(trade.id, ": status=").concat(trade.status, ", result=").concat(trade.result, ", isCompleted=").concat(isCompleted, ", hasResult=").concat(hasResult, ", isValidResult=").concat(isValidResult));
                                return isCompleted && hasResult && isValidResult;
                            });
                            completedTradesCount = completedTrades.length;
                            MINIMUM_TRADES_REQUIRED = 2;
                            console.log("\uD83D\uDCCA Trade requirement check for ".concat(user.username || user.email, ":"), {
                                totalTrades: userTrades.length,
                                completedTrades: completedTradesCount,
                                required: MINIMUM_TRADES_REQUIRED,
                                trades: userTrades.map(function (t) { return ({ id: t.id, status: t.status, result: t.result, symbol: t.symbol, amount: t.amount }); })
                            });
                            if (completedTradesCount < MINIMUM_TRADES_REQUIRED) {
                                console.log("\u274C Withdrawal blocked: User ".concat(user.username || user.email, " has only ").concat(completedTradesCount, "/").concat(MINIMUM_TRADES_REQUIRED, " completed trades with valid result"));
                                return [2 /*return*/, res.status(400).json({
                                        message: "Minimum trade requirement not met",
                                        details: "You need to complete at least ".concat(MINIMUM_TRADES_REQUIRED, " trades before withdrawing. Current: ").concat(completedTradesCount, "/").concat(MINIMUM_TRADES_REQUIRED, " trades completed.")
                                    })];
                            }
                            console.log("\u2705 Trade requirement met: User ".concat(user.username || user.email, " has ").concat(completedTradesCount, "/").concat(MINIMUM_TRADES_REQUIRED, " completed trades with valid result"));
                            return [4 /*yield*/, storage.getBalance(user.id, currency)];
                        case 2:
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, storage.updateBalance(user.id, currency, newAvailable, currentBalance.locked)];
                        case 5:
                            _c.sent();
                        ...
                        case 6:
                            error_89 = _c.sent();
                            console.error("Error processing withdrawal:", error_89);
            ...
            app.post("/api/transactions/withdraw", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var user, _a, amount, currency, address, method, currentBalance, transaction, newAvailable, notification, error_90;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 4, , 5]);
                        ...
                        case 4:
                            error_90 = _b.sent();
                            console.error("Error processing withdrawal:", error_90);
                            res.status(500).json({ message: "Failed to process withdrawal" });
                            return [3 /*break*/, 5];
                        case 5: return [2 /*return*/];
                    }
            ...
            app.get("/api/trades", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_91 = _a.sent();
                            console.error("Error fetching trades:", error_91);
                            res.status(500).json({ message: "Failed to fetch trades" });
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
            ...
            app.get("/api/market-data", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var forceRefresh, marketData, defaultMarketData, _i, defaultMarketData_1, data, error_92;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, storage.updateMarketData(data.symbol, {
                                    price: data.price,
                        ...
                        case 4:
                            _i++;
                            return [3 /*break*/, 2];
                        case 5: return [4 /*yield*/, storage.getAllMarketData()];
                        case 6:
                            marketData = _a.sent();
                        ...
                        case 8:
                            error_92 = _a.sent();
                            console.error("Error fetching market data:", error_92);
                            res.status(500).json({ message: "Failed to fetch market data" });
                            return [3 /*break*/, 9];
                        case 9: return [2 /*return*/];
                    }
            ...
            app.get("/api/setup/migrate-plain-password", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var error_93;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!pgRawClient) {
                                return [2 /*return*/, res.status(400).json({ success: false, error: 'PostgreSQL client not available' })];
                            }
                            // Add plain_password column if not exists using raw SQL
                            return [4 /*yield*/, pgRawClient(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        ALTER TABLE users ADD COLUMN IF NOT EXISTS plain_password VARCHAR(255)\n      "], ["\n        ALTER TABLE users ADD COLUMN IF NOT EXISTS plain_password VARCHAR(255)\n      "])))];
                        case 1:
                            // Add plain_password column if not exists using raw SQL
                            _a.sent();
                        ...
                        case 2:
                            error_93 = _a.sent();
                            console.error('❌ Migration error:', error_93);
                            // If column already exists, that's fine
                            if (error_93.message && error_93.message.includes('already exists')) {
                                res.json({ success: true, message: 'Column already exists' });
                            }
                            else {
                                res.status(500).json({ success: false, error: error_93.message });
                            }
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
            ...
            app.post("/api/setup/admin", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var walletAddress, user, error_94;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 6, , 7]);
                        ...
                        case 2:
                            ...
                            user = _a.sent();
                            return [3 /*break*/, 5];
                        case 3: return [4 /*yield*/, storage.updateUser(user.id, { role: 'super_admin' })];
                        case 4:
                        ...
                        case 6:
                            error_94 = _a.sent();
                            console.error("Error setting up admin:", error_94);
            ...
            _a = setupWebSocket(httpServer, storage), broadcastPriceUpdate = _a.broadcastPriceUpdate, broadcastToAll = _a.broadcastToAll;
            // Initialize demo data and start services
            setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                var users, hasRichDemoData, error_95, allTrades, now, completedCount, _i, allTrades_1, trade, error_96, error_97, error_98;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, seedOptionsSettings()];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, seedDemoData()];
                        case 3:
                            _a.sent();
                        ...
                        case 7:
                            error_95 = _a.sent();
                            console.error('⚠️ Error setting up chat tables (may already exist):', error_95);
                            return [3 /*break*/, 8];
                        case 8:
                        ...
                        case 9:
                            ...
                            now = new Date();
                            completedCount = 0;
                            _i = 0, allTrades_1 = allTrades;
                            _a.label = 10;
                        case 10:
                            if (!(_i < allTrades_1.length)) return [3 /*break*/, 15];
                            trade = allTrades_1[_i];
                            if (!(trade.status === 'active' && trade.expiresAt && new Date(trade.expiresAt) <= now)) return [3 /*break*/, 14];
                            console.log("\u23F0 Found expired trade: ".concat(trade.id, ", expired at ").concat(trade.expiresAt));
                            _a.label = 11;
                        case 11:
                            _a.trys.push([11, 13, , 14]);
                            return [4 /*yield*/, tradingService.executeOptionsTrade(trade.id)];
                        case 12:
                            _a.sent();
                            completedCount++;
                            console.log("\u2705 Auto-completed expired trade: ".concat(trade.id));
                            return [3 /*break*/, 14];
                        case 13:
                            error_96 = _a.sent();
                            console.error("\u274C Failed to auto-complete trade ".concat(trade.id, ":"), error_96);
                            return [3 /*break*/, 14];
                        case 14:
                            _i++;
                            return [3 /*break*/, 10];
                        case 15:
                            if (completedCount > 0) {
                                console.log("\u2705 Auto-completed ".concat(completedCount, " expired trades on server start"));
                            }
                            else {
                        ...
                        case 16:
                            error_97 = _a.sent();
                            console.error('❌ Error checking for expired trades:', error_97);
                            return [3 /*break*/, 17];
                        case 17:
                            ...
                            setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                                var allTrades, now, _i, allTrades_2, trade, error_99, error_100;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 8, , 9]);
                                        ...
                                        case 1:
                                            allTrades = _a.sent();
                                            now = new Date();
                                            _i = 0, allTrades_2 = allTrades;
                                            _a.label = 2;
                                        case 2:
                                            if (!(_i < allTrades_2.length)) return [3 /*break*/, 7];
                                            trade = allTrades_2[_i];
                                            if (!(trade.status === 'active' && trade.expiresAt && new Date(trade.expiresAt) <= now)) return [3 /*break*/, 6];
                                            console.log("\u23F0 Periodic check: Found expired trade ".concat(trade.id));
                                            _a.label = 3;
                                        case 3:
                                            _a.trys.push([3, 5, , 6]);
                                            return [4 /*yield*/, tradingService.executeOptionsTrade(trade.id)];
                                        case 4:
                                            _a.sent();
                                            console.log("\u2705 Periodic check: Completed expired trade ".concat(trade.id));
                                            return [3 /*break*/, 6];
                                        case 5:
                                            error_99 = _a.sent();
                                            console.error("\u274C Periodic check: Failed to complete trade ".concat(trade.id, ":"), error_99);
                                            return [3 /*break*/, 6];
                                        case 6:
                                            _i++;
                                            return [3 /*break*/, 2];
                                        ...
                                        case 8:
                                            error_100 = _a.sent();
                                            console.error('❌ Error in periodic expired trades check:', error_100);
                                            return [3 /*break*/, 9];
                                        case 9: return [2 /*return*/];
                                    }
                                });
                        ...
                        case 18:
                            error_98 = _a.sent();
                            console.error('❌ Error checking/seeding demo data:', error_98);
            ...
            app.get("/api/debug/check-withdrawal-eligibility", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var user, userTrades, completedTrades, error_101;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, res.json({
                                    ...
                                    allTrades: userTrades.map(function (t) { return ({
                                        id: t.id.substring(0, 8),
                                        status: t.status,
                                        result: t.result,
                                        symbol: t.symbol,
                        ...
                        case 2:
                            error_101 = _a.sent();
                            console.error("Error checking withdrawal eligibility:", error_101);
            ...
            app.post("/api/debug/complete-expired-trades", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var user, userTrades, now, completedCount, results, _i, userTrades_1, trade, error_102, error_103;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                            ...
                            console.log("\uD83D\uDD27 Manual trigger: Completing expired trades for user ".concat(user.id));
                            return [4 /*yield*/, storage.getUserTrades(user.id, 100)];
                        case 1:
                            userTrades = _a.sent();
                            now = new Date();
                            completedCount = 0;
                            results = [];
                            _i = 0, userTrades_1 = userTrades;
                            _a.label = 2;
                        case 2:
                            if (!(_i < userTrades_1.length)) return [3 /*break*/, 7];
                            trade = userTrades_1[_i];
                            if (!(trade.status === 'active' && trade.expiresAt && new Date(trade.expiresAt) <= now)) return [3 /*break*/, 6];
                            console.log("\u23F0 Manual: Found expired trade ".concat(trade.id, ", expired at ").concat(trade.expiresAt));
                            _a.label = 3;
                        case 3:
                            _a.trys.push([3, 5, , 6]);
                            return [4 /*yield*/, tradingService.executeOptionsTrade(trade.id)];
                        case 4:
                            ...
                            console.log("\u2705 Manual: Completed expired trade ".concat(trade.id));
                            return [3 /*break*/, 6];
                        case 5:
                            error_102 = _a.sent();
                            console.error("\u274C Manual: Failed to complete trade ".concat(trade.id, ":"), error_102);
                            results.push({ id: trade.id, status: 'failed', error: String(error_102) });
                            return [3 /*break*/, 6];
                        case 6:
                            _i++;
                            return [3 /*break*/, 2];
                        case 7: return [2 /*return*/, res.json({
                                message: "Completed ".concat(completedCount, " expired trades"),
                        ...
                        case 8:
                            error_103 = _a.sent();
                            console.error("Error completing expired trades:", error_103);
            ...
            app.get("/api/debug/users", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var users, adminUsers, error_104;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, ((_a = storage.getAllUsers) === null || _a === void 0 ? void 0 : _a.call(storage))];
                        case 1:
                            users = (_b.sent()) || [];
                        ...
                        case 2:
                            error_104 = _b.sent();
                            console.error('Debug users error:', error_104);
            ...
            app.post("/api/debug/admin-login", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var _a, username, password, user, isValidPassword, error_105;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 4, , 5]);
                        ...
                        case 4:
                            error_105 = _b.sent();
                            console.error('Debug login error:', error_105);
                            return [2 /*return*/, res.status(500).json({ message: "Debug login error", error: error_105.message })];
                        case 5: return [2 /*return*/];
                    }
                });
            }); });
            ...
            app.get("/api/admin/create-admins", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var adminUsers, createdUsers, _i, adminUsers_1, userData, existingUser, hashedPassword, user, error_106;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, storage.getUserByUsername(userData.username)];
                        case 2:
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, storage.createUser(__assign(__assign({}, userData), { password: hashedPassword, plainPassword: userData.password }))];
                        case 4:
                            user = _a.sent();
                        ...
                        case 8:
                            error_106 = _a.sent();
                            console.error("Create admin error:", error_106);
            ...
            app.get('/api/uploads/contact/:filename', function (req, res) {
                try {
                    var filename = req.params.filename;
                    var filePath = path.join(process.cwd(), 'uploads', 'contact', filename);
            ...
            app.get("/api/admin/system", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var responseData;
                return __generator(this, function (_a) {
                    try {
            ...
            app.get("/api/admin/system/logs/full", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var logs;
                return __generator(this, function (_a) {
                    try {
            ...
            app.get("/api/admin/system/logs", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var timestamp, logs;
                return __generator(this, function (_a) {
                    try {
            ...
            app.post("/api/admin/system/backup", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var fs_1, path_1, dbPath, backupPath, backupsDir;
                return __generator(this, function (_a) {
                    try {
                        fs_1 = require('fs');
                        path_1 = require('path');
                        dbPath = path_1.join(process.cwd(), 'dev.db');
                        backupPath = path_1.join(process.cwd(), 'backups', "backup-".concat(Date.now(), ".db"));
                        backupsDir = path_1.join(process.cwd(), 'backups');
                        if (!fs_1.existsSync(backupsDir)) {
                            fs_1.mkdirSync(backupsDir, { recursive: true });
                        }
                        // Copy database file
                        if (fs_1.existsSync(dbPath)) {
                            fs_1.copyFileSync(dbPath, backupPath);
                            console.log("\uD83D\uDCE6 Database backup created: ".concat(backupPath));
                            res.json({
                                success: true,
                                message: 'Database backup created successfully',
                                backupFile: path_1.basename(backupPath),
                                timestamp: new Date().toISOString()
                            });
                        }
                        else {
            ...
            app.post("/api/admin/system/clear-cache", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
            ...
            app.post("/api/admin/system/cache/clear", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        // In a production system, you'd clear Redis/Memcached here
                        // For now, we'll simulate cache clearing
            ...
            app.put("/api/admin/system/settings", requireSessionAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            app.get("/api/admin/activity-logs", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var _a, actionType, actionCategory, startDate, endDate, _b, limit, _c, offset, allLogs, localTotal, supabaseTotal, conditions, countResult, logs, transformedLogs, localError_1, query, _d, data, error, count, supabaseError_1, paginatedLogs, totalCount, error_107;
                var _e;
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            conditions = [eq(adminActivityLogs.isDeleted, false)];
                            if (actionType) {
                            ...
                            return [4 /*yield*/, db.select({ count: sql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["count(*)"], ["count(*)"]))) })
                                    .from(adminActivityLogs)
                                    .where(and.apply(void 0, conditions))];
                        case 2:
                            countResult = _f.sent();
                            localTotal = Number(((_e = countResult[0]) === null || _e === void 0 ? void 0 : _e.count) || 0);
                        ...
                        case 3:
                            logs = _f.sent();
                            transformedLogs = logs.map(function (log) { return ({
                                id: "local_".concat(log.id),
                            ...
                            allLogs = __spreadArray(__spreadArray([], allLogs, true), transformedLogs, true);
                            console.log("\u2705 Fetched ".concat(transformedLogs.length, " activity logs from local DB"));
                            _f.label = 4;
                        case 4: return [3 /*break*/, 6];
                        case 5:
                            localError_1 = _f.sent();
                            console.warn('⚠️ Local DB activity logs query failed:', localError_1);
                            return [3 /*break*/, 6];
                        case 6:
                            if (!supabaseAdmin) return [3 /*break*/, 10];
                            _f.label = 7;
                        case 7:
                            _f.trys.push([7, 9, , 10]);
                        ...
                        case 8:
                            _d = _f.sent(), data = _d.data, error = _d.error, count = _d.count;
                            if (!error && data) {
                                supabaseTotal = count || 0;
                                allLogs = __spreadArray(__spreadArray([], allLogs, true), data, true);
                                console.log("\u2705 Fetched ".concat(data.length, " activity logs from Supabase"));
                            }
                            else if (error) {
                            ...
                            return [3 /*break*/, 10];
                        case 9:
                            supabaseError_1 = _f.sent();
                            console.warn('⚠️ Supabase activity logs error:', supabaseError_1);
                            return [3 /*break*/, 10];
                        case 10:
                            ...
                            paginatedLogs = allLogs.slice(Number(offset), Number(offset) + Number(limit));
                            totalCount = localTotal + supabaseTotal;
                            console.log("\u2705 Total activity logs: ".concat(totalCount, " (local: ").concat(localTotal, ", supabase: ").concat(supabaseTotal, ")"));
                            res.json({
                                logs: paginatedLogs,
                                total: totalCount,
                                limit: Number(limit),
                        ...
                        case 11:
                            error_107 = _f.sent();
                            console.error("Error fetching activity logs:", error_107);
            ...
            app.get("/api/admin/activity-logs/stats", requireSessionSuperAdmin, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var totalCount, recent24hCount, byCategory_1, yesterday, totalResult, recent24hResult, categoryData, localError_2, supabaseTotal, supabaseRecent, categoryData, supabaseError_2, error_108;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, db.select({ count: sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["count(*)"], ["count(*)"]))) })
                                    .from(adminActivityLogs)
                                    .where(eq(adminActivityLogs.isDeleted, false))];
                        case 2:
                            totalResult = _c.sent();
                            totalCount += Number(((_a = totalResult[0]) === null || _a === void 0 ? void 0 : _a.count) || 0);
                            return [4 /*yield*/, db.select({ count: sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["count(*)"], ["count(*)"]))) })
                                    .from(adminActivityLogs)
                                    .where(and(eq(adminActivityLogs.isDeleted, false), gte(adminActivityLogs.createdAt, yesterday)))];
                        case 3:
                            recent24hResult = _c.sent();
                            recent24hCount += Number(((_b = recent24hResult[0]) === null || _b === void 0 ? void 0 : _b.count) || 0);
                            return [4 /*yield*/, db.select({ actionCategory: adminActivityLogs.actionCategory })
                                    .from(adminActivityLogs)
                                    .where(eq(adminActivityLogs.isDeleted, false))];
                        case 4:
                            categoryData = _c.sent();
                            categoryData === null || categoryData === void 0 ? void 0 : categoryData.forEach(function (log) {
                                var category = log.actionCategory;
                                byCategory_1[category] = (byCategory_1[category] || 0) + 1;
                            });
                            console.log("\u2705 Local DB stats: total=".concat(totalCount, ", recent24h=").concat(recent24hCount));
                            _c.label = 5;
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            localError_2 = _c.sent();
                            console.warn('⚠️ Local DB stats failed:', localError_2);
                            return [3 /*break*/, 7];
                        case 7:
                            if (!supabaseAdmin) return [3 /*break*/, 13];
                            _c.label = 8;
                        case 8:
                        ...
                        case 11:
                            ...
                            console.log("\u2705 Supabase stats added: total=".concat(supabaseTotal, ", recent=").concat(supabaseRecent));
                            return [3 /*break*/, 13];
                        case 12:
                            supabaseError_2 = _c.sent();
                            console.warn('⚠️ Supabase stats failed:', supabaseError_2);
                            return [3 /*break*/, 13];
                        case 13:
                            console.log("\u2705 Combined stats: total=".concat(totalCount, ", recent24h=").concat(recent24hCount, ", categories=").concat(Object.keys(byCategory_1).length));
                            res.json({
                                total: totalCount,
                        ...
                        case 14:
                            error_108 = _c.sent();
                            console.error("Error fetching activity log stats:", error_108);
