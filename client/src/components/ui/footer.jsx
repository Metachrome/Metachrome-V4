...
export function Footer() {
    return (<footer className="bg-[#181D20] border-t border-gray-600/30 w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and Description */}
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <img src={metachromeLogo} alt="METACHROME" className="h-8 w-auto"/>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/trade-policy" className="text-gray-400 hover:text-white text-sm">Trade Policy</Link></li>
        ...
        <div className="border-t border-gray-600/30 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-xs mb-4 md:mb-0">
            © 2025 <span className="font-bold text-purple-500">Metachrome</span>. All Rights Reserved
          </p>
