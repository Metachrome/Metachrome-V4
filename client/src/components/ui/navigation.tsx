...
// Navigation component without mobile menu for trading pages
export function NavigationNoMenu() {
  ...
  const getMobileUserDisplayName = () => {
    ...
    if (user.walletAddress) {
      return `${user.walletAddress.slice(0, 4)}...${user.walletAddress.slice(-2)}`;
    }
    ...
    <header className="bg-[#34344E] border-b border-gray-700/30">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-16">
              ...
              <div key={item.path} className="relative">
                {item.hasDropdown ? (
                  ...
                  >
                    ...
                    {isTradeOpen && (
                      <div className="absolute top-full left-0 mt-1 w-80 bg-[#1A1B3A] border border-gray-700 rounded-lg shadow-xl z-50">
                        <div className="p-4 space-y-3">
                          {/* SPOT Trading Option */}
                          <Link href="/trade/spot">
                            <div className="relative p-4 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg cursor-pointer transform transition-transform hover:scale-105">
                              <div className="flex items-center justify-between">
                                <div className="flex-1">
                                  <h3 className="text-lg font-bold text-black mb-1">SPOT</h3>
                                  <p className="text-black/80 text-sm">Trade cryptocurrencies with real-time market prices</p>
                                </div>
                                <div className="text-black/60 text-2xl ml-3">
                                  📈
                                </div>
                              </div>
                            </div>
                          ...
                          {/* OPTIONS Trading Option */}
                          <Link href="/trade/options">
                            <div className="relative p-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg cursor-pointer transform transition-transform hover:scale-105">
                              <div className="flex items-center justify-between">
                                <div className="flex-1">
                                  <h3 className="text-lg font-bold text-white mb-1">OPTIONS</h3>
                                  <p className="text-white/90 text-sm">High-yield binary options with fixed returns</p>
                                </div>
                                <div className="text-white/60 text-2xl ml-3">
                                  ⚡
                                </div>
                              </div>
                            </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {isAuthenticated ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 bg-[#1A1B3A] border-gray-700">
                  <DropdownMenuItem
          ...
          {/* Mobile right section - NO HAMBURGER MENU */}
