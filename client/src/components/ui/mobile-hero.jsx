...
export function MobileHero() {
    ...
    var handleStartTrading = function () {
        setLocation("/trade/options");
    };
    if (isMobile) {
        return (<section className="relative overflow-hidden bg-black">
        <div className="relative">
          <img src={heroMobileImage} alt="METACHROME Hero Banner" className="w-full h-auto object-cover" style={{ maxHeight: '280px' }} onError={function (e) {
          ...
          <div className="absolute bottom-6 left-4 z-20">
            <Button onClick={handleStartTrading} className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-6 py-2.5 rounded-lg text-base font-semibold border-0 shadow-lg">
              Start Trading
            </Button>
          </div>
        </div>
    ...
    return (<section className="relative overflow-hidden bg-black py-6">
      <div className="w-full px-4">
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="absolute bottom-20 left-8 z-20">
            <Button onClick={handleStartTrading} className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-3 rounded-lg text-lg font-semibold border-0 shadow-lg">
              Start Trading
            </Button>
          </div>
        </div>
