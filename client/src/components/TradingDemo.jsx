...
export default function TradingDemo(_a) {
    var type = _a.type;
    var _b = useState(118099.98), currentPrice = _b[0], setCurrentPrice = _b[1];
    var _c = useState(true), isConnected = _c[0], setIsConnected = _c[1];
    useEffect(function () {
        // Simulate real-time price updates
        var interval = setInterval(function () {
            setCurrentPrice(function (prev) {
    ...
    var getPriceChangeColor = function (current, previous) {
        if (current > previous)
    ...
    return (<div className="bg-[#10121E] border border-gray-700 rounded-lg p-4 mb-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-3">
          <div className={"w-3 h-3 rounded-full ".concat(isConnected ? 'bg-green-400' : 'bg-red-400')}></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-800 rounded p-3">
          ...
          <div className={"text-xl font-bold ".concat(getPriceChangeColor(currentPrice, 118099.98))}>
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          {type === 'spot' ? (<ul className="text-xs text-gray-400 space-y-1">
              <li>• Real TradingView charts</li>
              <li>• Live order book</li>
              <li>• Limit & Market orders</li>
              <li>• Portfolio tracking</li>
            </ul>) : (<ul className="text-xs text-gray-400 space-y-1">
