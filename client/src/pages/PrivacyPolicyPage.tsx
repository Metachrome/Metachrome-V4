  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Privacy Policy – Metachrome</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.3 Transaction Information</h3>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            To exercise these rights, please contact us at <a href="mailto:privacy@metachrome.io" className="text-blue-600 hover:underline">privacy@metachrome.io</a>
          </p>
          ...
          <ul className="list-none mb-4 text-gray-700">
            <li>Email: <a href="mailto:privacy@metachrome.io" className="text-blue-600 hover:underline">privacy@metachrome.io</a></li>
            <li>Support: <a href="mailto:support@metachrome.io" className="text-blue-600 hover:underline">support@metachrome.io</a></li>
          </ul>
