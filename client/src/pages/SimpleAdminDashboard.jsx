...
export default function SimpleAdminDashboard() {
    ...
    }), users = _b.data, isLoading = _b.isLoading;
    var handleLogout = function () {
        logout();
        window.location.href = '/admin/login';
    };
    var activeUsers = (users === null || users === void 0 ? void 0 : users.filter(function (u) { return u.isActive; })) || [];
    var totalUsers = (users === null || users === void 0 ? void 0 : users.length) || 0;
      ...
      <div className="bg-slate-800/90 border-b border-purple-500/20 p-4">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400">Welcome back, {user === null || user === void 0 ? void 0 : user.username}</p>
          </div>
        ...
        <Card className="bg-slate-800/90 border-purple-500/20">
          ...
          <CardContent>
            {isLoading ? (<div className="text-center py-8">
                ...
                {/* User Rows */}
                {users && users.length > 0 ? (users.map(function (user) { return (<div key={user.id} className="grid grid-cols-5 gap-4 p-4 bg-slate-700/30 rounded-lg hover:bg-slate-700/50 transition-colors">
