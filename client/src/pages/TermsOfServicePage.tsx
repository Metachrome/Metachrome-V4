  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Terms of Service – Metachrome</h1>
        <p className="text-gray-600 mb-8"><strong>Last updated:</strong> October 26, 2024</p>

        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
          <p className="text-gray-800">
            <strong>Important:</strong> By opening an account, using <a href="https://www.metachrome.io" className="text-blue-600 hover:underline">metachrome.io</a> and/or any Services provided by Metachrome, you acknowledge that you have read, understood, and agreed to these Terms of Service (the "Terms"). If you do not agree, you must cease using the Platform immediately.
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">(1) Our Agreement</h2>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">1.1 Preliminaries</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">1.2 Definitions</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <li><strong>"Digital Assets"</strong> means cryptocurrencies, tokens, and other blockchain-based assets</li>
          </ul>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">(4) Trading Services</h2>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <li>Market conditions may affect order execution</li>
          </ul>
          ...
          <p className="text-gray-700 mb-4">
            For questions about these Terms, please contact us at <a href="mailto:support@metachrome.io" className="text-blue-600 hover:underline">support@metachrome.io</a>
          </p>
