      ...
      <section className="relative overflow-hidden bg-black py-8">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="relative">
            ...
            <div className="absolute bottom-24 left-40 z-20">
              <Button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-3 rounded-lg text-lg font-semibold border-0 shadow-lg">
                Start Trading
              </Button>
            </div>
          </div>
