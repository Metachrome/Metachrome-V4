...
async function runTests() {
  ...
  try {
    ...
    // Test 4: Test manual deposit
    console.log('4️⃣ Testing: Manual deposit');
    ...
    console.log(`   Result:`, manualDeposit.data);
    console.log('');

    // Test 5: Final transaction count
    console.log('5️⃣ Testing: Final transaction count');
    const finalTransactionsResult = await testAPI('/api/admin/transactions');
    console.log(`   Status: ${finalTransactionsResult.status}`);
    console.log(`   Final transactions count: ${finalTransactionsResult.data.length}`);
    console.log('');
