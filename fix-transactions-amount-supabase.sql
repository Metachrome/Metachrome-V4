...
-- Step 3: Also fix fee and network_fee columns if they exist
ALTER TABLE transactions 
ALTER COLUMN fee TYPE DECIMAL(18,8);

ALTER TABLE transactions 
ALTER COLUMN network_fee TYPE DECIMAL(18,8);
...
-- Step 5: Check if there are any transactions with amount = 0 that should have values
